...
double getDistance()
{
	// Trigger Signal
	  ...
	  // Distance = (ECHO high level time X ultrasonic velocity in air 340m/sec) / 2
	  double dist = (t2 - t1) * 0.0170;	// centi meter
	  return dist;
}
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  printf("\033[10;20H Distance : %.2f cm  \r\n", getDistance());
